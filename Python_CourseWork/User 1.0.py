...
# Modify the hall_booking function
def hall_booking(input_username_login, user_email):
    while True:
        ...
        with open("bookinginfo.txt", "a") as f:
            f.write(f"{event_name};{event_description};{hall_id};{number_of_pax};"
                    f"{date_renting} {time_renting};{payment_price};{input_username_login};"
                    f"{user_email}:{hour_of_renting}\n")
...
def view_booking_info(input_username_login, user_email):
    ...
    try:
        ...
        print("Error: bookinginfo.txt not found.")
        return
    ...
    for line in lines:
        ...
        if search_term in line:
            ...
            print("{:<15} {:<20} {:<10} {:<15} {:<25} {:<15} {:<15} {:<20}".format(
                "Event name", "Event description", "Hall id", "Number of pax",
                "Date and Time", "Payment price", "Username", "Email"))
            print("{:<15} {:<20} {:<10} {:<15} {:<25} {:<15} {:<15} {:<20}".format(
                *booking_info[:2], booking_info[2], booking_info[3],
                f"{booking_info[4]} {booking_info[5]}", booking_info[6],
                booking_info[7] if len(booking_info) > 7 else '', booking_info[8] if len(booking_info) > 8 else ''))
            ...
            for i, line in enumerate(lines):
                ...
                if search_term in line:
                    ...
                    while True:
                        ...
                        for j, info in enumerate(booking_info):
                            print(f"{j + 1}) {info}")
            ...
            for i, line in enumerate(lines):
                ...
                if search_term in line:
                    ...
                    while True:
                        ...
                        print("{:<15} {:<10} {:<15} {:<15} {:<30} {:<15} {:<15} {:<15} {:<20}".format(
                            "Event name", "Hall id", "Number of pax", "Date and Time",
                            "Payment price", "Username", "Event description", "Email", "Hours of renting"))
                        print("{:<15} {:<10} {:<15} {:<15} {:<30} {:<15} {:<15} {:<15} {:<20}".format(
                            *booking_info[:8], booking_info[4] + ' ' + booking_info[5], booking_info[8]))
